function sendMessage() {
    ...
    socket.onmessage = function(event) {
        ...
        if (isValidUrl(serverResponse)) {
            ...
            if (fileType === 'image') {
                mediaViewer.innerHTML = '<img src="' +"C:/Users/rahim/Desktop/website/personal_assistant_webapp_with_generative_ai/user1/data/"+ serverResponse + '" alt="Image">';
            } else if (fileType === 'video') {
                mediaViewer.innerHTML = '<video controls><source src="' +"C:/Users/rahim/Desktop/website/personal_assistant_webapp_with_generative_ai/user1/data/"+ serverResponse + '" type="video/mp4"></video>';
            } else if (fileType === 'audio') {
                mediaViewer.innerHTML = '<audio controls><source src="' + "C:/Users/rahim/Desktop/website/personal_assistant_webapp_with_generative_ai/user1/data/"+serverResponse + '" type="audio/mpeg"></audio>';
